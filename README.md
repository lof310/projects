...
- **Other pieces** – I'm also poking at attention (replacements of attention) and feed-forward blocks (whole different architectures, not just new activation functions). No published code yet and probably i won't publish as open-source never.
